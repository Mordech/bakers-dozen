...
// Recipe creator
function createRecipe(hydration, size, ingredients, small, medium, large) {
  ...
  recipe.unshift(flour, water);

  return recipe;
}

// This is a breakdown of all the recipes in the app
...
function makePizza(hydration, size) {
  return createRecipe(hydration, size, pizzaIngredients, 200, 250, 300);
}
...
function makeBread(hydration, size) {
  return createRecipe(hydration, size, breadIngredients, 480, 640, 1000);
}
...
function makePretzel(hydration, size) {
  return createRecipe(hydration, size, pretzelIngredients, 600, 750, 900);
}

const pretzelInstructions = [
...
export {
  makePizza,
  pizzaInstructions as pizzaInstructions,
  makeBread,
  breadInstructions as breadInstructions,
  makePretzel,
  pretzelInstructions as pretzelInstructions,
};
